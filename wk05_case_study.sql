-- Week 6 questions
-- Has 4 quiz questions about sets
-- The last 6 questions are listed below.
USE sakila;
...
-- --------------------------------------------------------------------------
-- 2. Sort the results from Exercise 6-2 by the last_name column.
-- +------------+--------------+
-- | first_name | last_name    |
-- +------------+--------------+
-- | MISTY      | LAMBERT      |
...
-- --------------------------------------------------------------------------
-- 3. Write a compound query that finds the id and name 
-- of all cities and countries that have a name starting with 
...
-- --------------------------------------------------------------------------
-- 4. Write a compound query that finds the id and name of all cities 
...
-- --------------------------------------------------------------------------
-- 5. Write a compound query that finds the first_name, last_name, and title 
-- where the first_name starts with an 'M' and the film starts with 'LOVE' 
-- and the first_name, last_name, and title where the last_name 
-- starts with an 'W' and the film title starts with 'LIFE' 
...
-- +-----------+------------------+
-- | HOPPER    | LOVER TRUMAN     |
-- | KEITEL    | LOVELY JINGLE    |
-- | KEITEL    | LOVER TRUMAN     |
-- | KILMER    | LOVELY JINGLE    |
-- | MCDORMAND | LOVERBOY ATTACKS |
-- | WAHLBERG  | LIFE TWISTED     |
-- | WEST      | LIFE TWISTED     |
-- | WOOD      | LIFE TWISTED     |
-- +-----------+------------------+
-- --------------------------------------------------------------------------
